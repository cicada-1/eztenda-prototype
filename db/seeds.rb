...
brand3 = Brand.create!(brand_name: "Jack Daniel's",
                    ...
                    #    password: "123456",
                       ...
                       description: "You favourite whisky brand",
                       user_id: user9.id                     
)
...
offer1 = Offer.create!(venue_id: venue1.id, min_bid: "2500", contract_length: "24", estimated_volume: "1500 bottles", category: "Whisky")
offer2 = Offer.create!(venue_id: venue2.id, min_bid: "3000", contract_length: "24", estimated_volume: "1400 bottles", category: "Gin")
offer3 = Offer.create!(venue_id: venue3.id, min_bid: "2750", contract_length: "12", estimated_volume: "500 bottles", category: "Vodka")
offer4 = Offer.create!(venue_id: venue4.id, min_bid: "1500", contract_length: "18", estimated_volume: "1000 bottles", category: "Vodka")
offer5 = Offer.create!(venue_id: venue5.id, min_bid: "4000", contract_length: "20", estimated_volume: "1200 bottles", category: "Gin")
offer6 = Offer.create!(venue_id: venue6.id, min_bid: "3200", contract_length: "20", estimated_volume: "1200 bottles", category: "Whisky")

puts "Creating 6 bids"

bid1 = Bid.create!(brand_id: brand6.id, offer_amount: "2800", additional: "200 Branded glasses", )
bid2 = Bid.create!(brand_id: brand5.id, offer_amount: "1500", additional: "100 Branded T-shirts", )
bid3 = Bid.create!(brand_id: brand3.id, offer_amount: "2800", additional: "800 Branded coasters", )
bid4 = Bid.create!(brand_id: brand4.id, offer_amount: "3500", additional: "500 Branded glasses", )
bid5 = Bid.create!(brand_id: brand1.id, offer_amount: "4200", additional: "100 Branded glasses", )
bid6 = Bid.create!(brand_id: brand2.id, offer_amount: "3500", additional: "200 Branded caps", )
